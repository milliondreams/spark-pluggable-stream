...
import spark.streaming.receivers.SubscribeReceiver
import spark.streaming.receivers.UnsubscribeReceiver
import spark.util.AkkaUtils

/**
 * A feeder to which multiple message receiver (specified by "noOfReceivers")
 * actors subscribe and receive file(s)'s text as stream of messages. This is provided
 * as a demonstration app for trying out MessageStreamReceiver
 */
